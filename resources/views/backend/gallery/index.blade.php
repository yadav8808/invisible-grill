...
<div class="page-header d-xl-flex d-block">
    <div class="page-leftheader">
        <h4 class="page-title">Gallery <span class="font-weight-normal text-muted ms-2">Lists</span></h4>
        <small class="text-muted">Total Gallery Items: {{ $galleries->total() }}</small>
    </div>
            ...
            <div class="d-lg-flex d-block">
                <div class="btn-list">
                    <a href="{{ route('galleries.create') }}" class="btn btn-primary">
                        <i class="feather feather-plus fs-15 my-auto me-2"></i>Add Gallery Item
                    </a>
                </div>
            </div>
        </div>
...
{{-- Filters --}}
@include('backend.gallery._search') {{-- optional: search partial similar to banners --}}
