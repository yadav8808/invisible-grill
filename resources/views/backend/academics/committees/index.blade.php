...
@section('content')
    <div class="page-header d-flex justify-content-between">
        <h4 class="page-title">Committees List</h4>
        <a href="{{ route('committees.create') }}" class="btn btn-primary">Add New</a>
    </div>
    @include('backend.academics.committees._search')
    <div class="card">
                ...
                <tbody>
                    @forelse($committees as $committee)
                        <tr>
                            ...
                            <td>
                            <a href="{{ route('committees.edit', $committee) }}" class="btn btn-sm btn-info">
                            ...
                            <button type="button"
                                    ...
                                    data-url="{{ route('committees.destroy', $committee) }}"
